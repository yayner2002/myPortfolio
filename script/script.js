...
},
{
  ...
  popTitle: 'Keeping track of hundreds of space  and Missions',
  popDescription: 'Build a web application for a company that provides commercial and scientific space travel services. The application will allow users to book rockets and join selected space missions. the webiste uses real live data from the SpaceX API.',
  technologies: ['React', 'Redux', 'Javascript', 'ReduxToolkit'],
  popupTech: ['Codekit', 'GitHub', 'javaScript', 'Bootstrap', 'ReduxToolkit', 'Javascript'],
